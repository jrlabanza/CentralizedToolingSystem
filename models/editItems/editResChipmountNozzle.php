...
if (empty($_SESSION['line'])){
	$sql = "SELECT * from chipmount_nozzle ORDER BY id DESC";
}else{
	$sql = "SELECT * from chipmount_nozzle WHERE line = '$_SESSION[line]' ORDER BY id DESC";
}

$paginationlink = "models/editItems/editResCipmountNozzle.php?page=";
