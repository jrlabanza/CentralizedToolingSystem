				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							SERIAL ID:<input id="gettd1" name="socketid" type="text" class="form-control mb-2" required>
							TESTER PF:<input id="gettd2" name="tstPf" type="text" class="form-control mb-2" required>
              				DEVICE NAME:<input id="gettd3" name="family" type="text" class="form-control mb-2" required>
							PACKAGE TYPE:<input id="gettd4" name="getgoodQty" type="text" class="form-control mb-2" required>
              				LINE:<select id="gettd5" name="line" class="form-control mb-2" required>
						...
						<div class="col-md-6">
							ACU NEED:<input id="gettd6" name="testType" type="text" class="form-control mb-2 isNumberKey" maxlength="2" required>
            				BARE DEVICES:<input id="gettd7" name="testType" type="text" class="form-control mb-2 isNumberKey" maxlength="3" required>
							PCB BOARD:<input id="gettd8" name="pcbBoard" type="text" class="form-control mb-2 isNumberKey" maxlength="3" required>
							ADAP BOARD:<input id="gettd9" name="adapBoard" type="text" class="form-control mb-2 isNumberKey" maxlength="3" required>
							RACK:<input id="gettd10" name="storage" type="text" class="form-control mb-2" required>
						</div>
						 <div class="col-md-12">
							REMARKS:<textarea id="gettd11" name="remarks" class="form-control mb-2" rows="2" required></textarea>
						 </div>
					</div>
					<div class="row">
						<div class="col-md-12">
...
<script>
getresult("models/editItems/editResATC.php");
