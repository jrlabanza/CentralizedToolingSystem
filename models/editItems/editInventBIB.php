		...
		<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">UPDATE BURN IN BOARD INFORMATION</h5>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-4">
							...
							BARCODE:<input id="gettd8" name="barcode" type="text" class="form-control mb-2">
							SERIAL ID:<input id="gettd1" name="socketid" type="text" class="form-control mb-2" readonly>
							FAMILY:<input id="gettd2" name="family" type="text" class="form-control mb-2" required>
						</div>
						<div class="col-md-4">
							RACK:<input id="gettd4" name="storage" type="text" class="form-control mb-2" required>	
							BIB ID:<input id="gettd9" name="bib_id" type="text" class="form-control mb-2">						</div>
						<div class="col-md-4">
						 ...
						 <div class="col-md-12">
							REMARKS:<textarea id="gettd7" name="remarks" class="form-control mb-2" rows="2"></textarea>
						 </div>
					</div>
					<div class="row">
						<div class="col-md-12">
...
<script>
getresult("models/editItems/editResBIB.php");
</script>
