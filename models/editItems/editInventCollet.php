		...
		<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">UPDATE COLLET INFORMATION</h5>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							COLLET PART NO.:<input id="gettd1" name="nozzlePrtNO" type="text" class="form-control mb-2" required="">
...
<script>
getresult("models/editItems/editResCollet.php");
</script>
