		...
		<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">UPDATE CENTER BOARD INFORMATION</h5>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-4">
							...
							SERIAL ID:<input id="gettd1" name="srid" type="text" class="form-control mb-2" readonly>
							TYPE:<input id="gettd2" name="lbid" type="text" class="form-control mb-2" required>
...
<script>
getresult("models/editItems/editResCB.php");
</script>
