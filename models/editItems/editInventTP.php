		...
		<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">UPDATE TESTER PARTS INFORMATION</h5>
				...
				<div class="col-sm-6">
					...
					ITEM NAME:<input id="gettd1" name="itm_nm" type="text" class="form-control mb-2 getItemName" tabindex="-1">
					PART NO:<input id="gettd3" name="prt_no" type="text" class="form-control mb-2 getPartNumber" tabindex="-1">
					VENDOR:<input id="gettd5" name="vendor" type="text" class="form-control mb-2 getVendor " tabindex="-1">
					STATUS:<input id="gettd7" name="status" type="text" class="form-control mb-2 getStatus " tabindex="-1">
					REMARKS:<input id="gettd9" name="remarks" type="text" class="form-control mb-2 getRemarks" tabindex="-1">		

				</div>
				<div class="col-sm-6">
					PART NAME:<input id="gettd2" name="dscrptn" type="text" class="form-control mb-2 getPartName" tabindex="-1">
					SERIAL NO::<input id="gettd4" name="srl_no" type="text" class="form-control mb-2 getSerialNumber" tabindex="-1">
					TESTER PLATFORM:<input id="gettd6" name="mchn_model" type="text" class="form-control mb-2 getTesterPlatform" tabindex="-1">	
					LOCATION:<input id="gettd8" name="lction" type="text" class="form-control mb-2 getLocation" tabindex="-1">	
					QUANTITY:<input id="gettd10" name="quantity" type="text" class="form-control mb-2 getCurrentQuantity" tabindex="-1">	
				</div>
...
<script>
getresult("models/editItems/editResTP.php");
</script>
