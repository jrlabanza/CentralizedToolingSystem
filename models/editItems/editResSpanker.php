...
$paginationlink = "models/editItems/editResSpanker.php?page=";
...
$output .= '<table id="keywords" class="table table-bordered table-sm-responsive table-hover">
	<thead id="thead" class="thead-light">
		<tr>
			...
			<th scope="col" class="col-sm-0">SPANKER PART NO.</th>
			<th scope="col" class="col-sm-0">ALTERNATIVE SPANKER</th>
			<th scope="col" class="col-sm-0">SPANKER TYPE</th>			
