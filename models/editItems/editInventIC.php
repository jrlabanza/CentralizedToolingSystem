		...
		<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">UPDATE NOZZLE INFORMATION</h5>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							LF NAME:<input id="gettd1" name="nozzlePrtNO" type="text" class="form-control mb-2" required>
							PACKAGE:<input id="gettd3" name="package" type="text" class="form-control mb-2" required>
							INSERT SN:<input id="gettd4" name="insertSN" type="text" class="form-control mb-2" required>
						...
						<div class="col-md-6">
						MACHINE MODEL:<input id="gettd6" name="machineModel" type="text" class="form-control mb-2" required>
						MAX SHOT:<input id="gettd7" name="mShot" type="text" class="form-control mb-2 isNumberKey" maxlength="10" required>
						DRAWING NO:<input id="gettd8" name="drawingNo" type="text" class="form-control mb-2" required>
						CLAMP SN:<input id="gettd9" name="clampSN" type="text" class="form-control mb-2" required>
						REMARKS:<textarea id="gettd10" name="remarks" class="form-control mb-2" rows="3"></textarea>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
...
<script>
getresult("models/editItems/editResIC.php");
</script>
