...
if (empty($_SESSION['line'])){
	$sql = "SELECT * from nozzle ORDER BY id DESC";
}else{
	$sql = "SELECT * from nozzle WHERE line = '$_SESSION[line]' ORDER BY id DESC";
}

$paginationlink = "models/editItems/editResNozzle.php?page=";
