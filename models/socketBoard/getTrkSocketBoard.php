...
if($_POST['id']){
	$id=$_POST['id'];
	$result = $conn->query('SELECT * FROM socket_board WHERE socket_id="'.$id.'"');
	while ($row = $result->fetch_assoc()) { 
?>
...
<?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="getLBID">SOCKET BOARD ID:</label><input id="getLBID" name="socketid" type="text" class="form-control" readonly="" tabindex="-1" value="<?php echo $row['socket_id']; ?>">
...
?>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <label for="getTstPF">SHOT COUNT:</label><input id="getShotCnt" name="shotCnt" type="text" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-8">
                                                ...
                                                <input id="sfileSocket" class="form-control" name="sfile" type="file" value="Choose file" accept=".jpg, .txt, .doc, .docx, .pdf, .xlsx, .csv, .jpeg, .jpg, .png, .bmp, .msg, .asc">
