...
$sql = "SELECT * FROM socket_board_history ORDER BY date_time DESC";
$paginationlink = "models/socketBoard/pagiResSocketBoardHis.php?page=";
...
$output .= '<table id="keywords" class="table table-bordered table-sm-responsive table-hover">
	...
	if ($_GET["rowcount"] > 0){
		...
		<tr style="cursor: pointer;">
			<td colspan="23" class="text-center bg-warning"><strong>EMPTY RESULTS<strong></td>
		</tr>';
	}
$output .= '</tbody>
</table>';
