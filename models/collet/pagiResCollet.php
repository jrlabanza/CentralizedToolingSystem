...
if (empty($_SESSION['line'])){
	$sql = "SELECT * from collet ORDER BY last_update DESC";
}else{
	$sql = "SELECT * FROM collet WHERE line = '$_SESSION[line]' ORDER BY last_update DESC";
}

$paginationlink = "models/collet/pagiResCollet.php?page=";
...
$output .= '<table id="keywords" class="table table-bordered table-sm-responsive table-hover">
	<thead id="thead" class="thead-light">
		...
		<th scope="col" class="col-sm-0">COLLET DESCRIPTION.</th>
