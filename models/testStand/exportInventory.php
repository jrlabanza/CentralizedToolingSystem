...
$result = $conn->query('SELECT serial_id, family, tst_pf, status, tester_id, handler_id, hd_pf, loc, rack, line, vendor, date_time, last_update, clerk, sFile, remarks FROM test_stand ORDER BY serial_id ASC');
$file_ending = "xls";
