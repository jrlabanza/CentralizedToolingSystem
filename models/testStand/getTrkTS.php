...
if($_POST['id']){
	$id=$_POST['id'];
	$result = $conn->query('SELECT * FROM test_stand WHERE serial_id="'.$id.'"');
	while ($row = $result->fetch_assoc()) {
		$status = $row['status'];
?>
...
<?php }} ?>
										...
										<div class="row">
											<div class="col-md-6">
												...
												RACK:<input id="getStrg" name="storage" type="text" class="form-control mb-2" readonly="" tabindex="-1" value="<?php echo $row['rack'] ?>">
											</div>
											<div class="col-md-6">
