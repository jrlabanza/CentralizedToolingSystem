...
if (empty($_SESSION['line'])){
	$sql = "SELECT * from tstpartstrck ORDER BY id DESC";
}else{
	$sql = "SELECT * FROM tstpartstrck WHERE line = '$_SESSION[line]' ORDER BY id DESC";
}

$paginationlink = "models/delItems/delResTP.php?page=";
