...
if (empty($_SESSION['line'])){
	$sql = "SELECT * from center_board ORDER BY id DESC";
}else{
	$sql = "SELECT * FROM center_board WHERE line = '$_SESSION[line]' ORDER BY id DESC";
}

$paginationlink = "models/delItems/delResCB.php?page=";
...
if(!empty($perpageresult)) {
	...
	$output = '<button id="bttnDel" class="btn btn-danger" style="margin-left: 20px;" data-toggle="modal" data-target="#bd-example-modal-md">DELETE</button><br/><br/>';
}
