...
$paginationlink = "models/delItems/delResGNG.php?page=";
...
$output .= '<table id="keywords" class="table table-bordered table-sm-responsive table-hover">
	<thead id="thead" class="thead-light">
		<tr>
			...
			<th scope="col" class="col-sm-0">NO GOOD</th>
		...
		foreach($faq as $k=>$v) {
			$output .= '
					<tr>
						...
						<td class="strg">' . $faq[$k]['good_qty'] . '</td>
						<td class="strg">' . $faq[$k]['nogood_qty'] . '</td>
