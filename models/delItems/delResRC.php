...
if (empty($_SESSION['line'])){
	$sql = "SELECT * from rubber_collet ORDER BY id DESC";
}else{
	$sql = "SELECT * FROM rubber_collet WHERE line = '$_SESSION[line]' ORDER BY id DESC";
}

$paginationlink = "models/delItems/delResRC.php?page=";
