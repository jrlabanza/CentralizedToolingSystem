...
if(!empty($perpageresult)) {
	$output = '<nav aria-label="..."><ul class="pagination">' . $perpageresult . '</ul><button type="button" class="btn btn-link" onclick=location.href="models/ic/exportInventory.php">Download Inventory</button>';
	$output .= '';
}else{
	$output = '';
}
