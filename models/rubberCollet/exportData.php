...
//}
echo "ITEM NAME".$sep."DESCRIPTION".$sep."VENDOR".$sep."MACHINE MODEL".$sep."PART NUMBER".$sep."SERIAL NUMBER".$sep."STATUS".$sep."LOCATION".$sep."REMARKS".$sep."PERSON".$sep."DATETIME".$sep."QUANTITY".$sep."INSTALLED TO";
print("\n");
