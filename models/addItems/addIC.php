<div class="page-content">
  <div class="card mb-3">
    <div class="card-header bg-secondary text-white">
      <h5>INSERT & CLAMP INFORMATION</h5>
    </div>
    <div class="card-body">
        ...
        <form method="post" action="" enctype="multipart/form-data">
          <div class="d-flex">
            <div class="col-md-6 p-2 flex-fill">
              LF NAME:<input id="td1" name="nozzlePrtNO" type="text" class="form-control mb-2" required>
              BOX NO.:<input id="td2" name="boxNo" type="text" class="form-control mb-2">
              PACKAGE:<input id="td3" name="package" type="text" class="form-control mb-2" required>
              INSERT SN:<input id="td4" name="insertSN" type="text" class="form-control mb-2" required>
            ...
            <div class="col-md-6 p-2 flex-fill">
              ...
              DRAWING NO:<input id="td8" name="drawingNo" type="text" class="form-control mb-2" required>
              CLAMP SN:<input id="td9" name="clampSN" type="text" class="form-control mb-2" required>
              REMARKS:<textarea id="td10" name="remarks" class="form-control mb-2" rows="3"></textarea>
            </div>
          </div>
