<div class="page-content">
  <div class="card mb-3">
    <div class="card-header bg-secondary text-white">
      <h5>CHIPMOUNT NOZZLE INFORMATION</h5>
    </div>
    <div class="card-body">
        ...
        <form method="post" action="" enctype="multipart/form-data">
          <div class="d-flex">
            <div class="col-md-6 p-2 flex-fill">
              NOZZLE PART NO.:<input id="td1" name="nozzlePrtNO" type="text" class="form-control mb-2" required>
              BOX NO.:<input id="td2" name="boxNo" type="text" class="form-control mb-2">
              NOZZLE TYPE:<input id="td3" name="package" type="text" class="form-control mb-2" required>
              ALTERNATIVE NOZZLE:<input id="td4" name="altrntvNozzle" type="text" class="form-control mb-2" required>
