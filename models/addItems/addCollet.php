        ...
        <form method="post" action="" enctype="multipart/form-data">
          <div class="d-flex">
            <div class="col-md-6 p-2 flex-fill">
              COLLET PART NO.:<input id="td1" name="nozzlePrtNO" type="text" class="form-control mb-2" required>
              BOX NO.:<input id="td2" name="boxNo" type="text" class="form-control mb-2">
              COLLET TYPE:<input id="td3" name="package" type="text" class="form-control mb-2" required>
              ALTERNATIVE COLLET:<input id="td4" name="altrntvNozzle" type="text" class="form-control mb-2" required>
