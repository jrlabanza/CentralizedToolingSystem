<div class="page-content">
  <div class="card mb-3">
    <div class="card-header bg-secondary text-white">
      <h5>SOCKET BOARD INFORMATION</h5>
    </div>
    <div class="card-body">
        <form method="post" action="" enctype="multipart/form-data">
          <div class="d-flex">
            <div class="col-md-6 p-2 flex-fill">
              SOCKET BOARD ID:<input id="td1" name="socketid" type="text" class="form-control mb-2" required="">
              ...
              TEMP:<select id="td5" name="temp" class="form-control mb-2" required>
