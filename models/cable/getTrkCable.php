...
if($_POST['id']){
	$id=$_POST['id'];
	$result = $conn->query('SELECT * FROM cable WHERE serial_id="'.$id.'"');
	while ($row = $result->fetch_assoc()) {
		$status = $row['status'];
?>
...
<?php }} ?>
										...
										<div class="row">
											<div class="col-md-6">
												...
												CONNECTION TYPE:<input id="getLBID" name="lbid" type="text" class="form-control mb-2" readonly="" tabindex="-1" value="<?php echo $row['conn_type'] ?>">
