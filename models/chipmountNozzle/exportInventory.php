...
$result = $conn->query('SELECT box_no,package,altrntv_nozzle,nozzle_partno,status,machine_model,machine_id,shots,max_shots,remarks,last_update FROM chipmount_nozzle ORDER BY box_no ASC');
$file_ending = "xls";
