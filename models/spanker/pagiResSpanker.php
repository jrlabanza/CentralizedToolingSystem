...
if (empty($_SESSION['line'])){
	$sql = "SELECT * from spanker ORDER BY last_update DESC";
}else{
	$sql = "SELECT * FROM spanker WHERE line = '$_SESSION[line]' ORDER BY last_update DESC";
}

$paginationlink = "models/spanker/pagiResSpanker.php?page=";
