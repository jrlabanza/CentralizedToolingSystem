  ...
  <div class="page-content">
    <div class="card">
      <div class="card-header">
        <h3>DELETE ITEM INVENTORY</h3>
      </div>
      <div class="card-body">
        <div class="form-inline">
          <span>
            <select id="delCategory" name='category' class="form-control">
          ...
          <?php }}else{ ?>
            ...
            <span id="delSearch" style="display: none;">
              <input type="text" class="form-control" id="delKeyword" placeholder="Keyword">
              <button class="btn btn-primary" id="delBttnSearch">SEARCH</button></span>
            </span>
