...
<div class="page-content"  style="width: 1600px;">
  <div class="card">
    <div class="card-header">
      SOCKET BOARD HISTORY
    </div>
    <div class="card-body">
      <form class="form-inline" method="post" action="models/socketBoard/exportData.php">
          ...
          <button id="bttnSearchSocketBoard" type="button" class="btn btn-success mb-2 mr-sm-2">GO</button>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/socketBoard/pagiResSocketBoardHis.php");
	}
}
</script>
<script>
