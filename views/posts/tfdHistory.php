...
<div class="page-content"  style="width: 1600px;">
  <div class="card">
    <div class="card-header">
      TRIM AND FORM DIESETS
    </div>
    <div class="card-body">
      <form class="form-inline" method="post" action="models/trimAndFormDiesets/exportData.php">
          <input type="text" name="serialID" class="form-control mb-2 mr-sm-2 IDHist" id="mcIDHist" placeholder="KEYWORD">
          ...
          <button id="bttnSearchtfd" type="button" class="btn btn-success mb-2 mr-sm-2">GO</button>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/trimAndFormDiesets/pagiResTFDSHis.php");
	}
}
</script>
<script>
