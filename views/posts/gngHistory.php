...
<div class="page-content"  style="width: 1600px;">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-inline" method="post" action="models/gng/exportData.php">
          <input type="text" name="serialID" class="form-control mb-2 mr-sm-2 IDHist" id="gngIDHist" placeholder="SERIAL ID">
          ...
          <button id="bttnSearchGNG" type="button" class="btn btn-success mb-2 mr-sm-2">GO</button>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/gng/pagiResGNGHis.php");
	}
}
</script>
<script>
