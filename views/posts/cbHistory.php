...
<div class="page-content"  style="width: 1600px;">
  <div class="card">
    <div class="card-header">
      CENTER BOARD HISTORY
    </div>
    <div class="card-body">
      <form class="form-inline" method="post" action="models/centerBoard/exportData.php">
          <input type="text" name="serialID" class="form-control mb-2 mr-sm-2 IDHist" id="cbIDHist" placeholder="Keyword">
          ...
          <button id="bttnHistCBSearch" type="button" class="btn btn-success mb-2 mr-sm-2">GO</button>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/centerBoard/pagiResCBHis.php");
	}
}
</script>
<script>
