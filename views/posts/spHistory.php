...
<div class="page-content"  style="width: 1600px;">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-inline" method="post" action="models/spareParts/exportData.php">
          <input type="text" name="serialID" class="form-control mb-2 mr-sm-2 IDHist" id="rcIDHist" placeholder="Keyword.">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/spareParts/pagiResSPHis.php");
	}
}
</script>
<script>
