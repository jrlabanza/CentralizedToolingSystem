...
<div class="page-content"  style="width: 1600px;">
  <div class="card">
    <div class="card-header">
      RUBER COLLET HISTORY
    </div>
    <div class="card-body">
      <form class="form-inline" method="post" action="models/rubberCollet/exportData.php">
          <input type="text" name="serialID" class="form-control mb-2 mr-sm-2 IDHist" id="rcIDHist" placeholder="RUBBER TIP NO.">
          ...
          <button id="bttnHistRCSearch" type="button" class="btn btn-success mb-2 mr-sm-2">GO</button>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/rubberCollet/pagiResRCHis.php");
	}
}
</script>
<script>
