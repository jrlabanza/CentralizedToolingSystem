...
<div class="page-content"  style="width: 1600px;">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-inline" method="post" action="models/testStand/exportData.php">
          ...
          <button id="bttnSearchTS" type="button" class="btn btn-success mb-2 mr-sm-2">GO</button>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/testStand/pagiResTSHis.php");
	}
}
</script>
<script>
