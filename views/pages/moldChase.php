...
?>
		<form id="saveData" method="post" action="models/moldchase/saveMC.php" enctype="multipart/form-data">
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									MOLD CHASE NO.:<input id="gettd1" name="moldChaseNo" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									...
									MOLD DIE ID:<input id="gettd3" name="moldDieID" type="text" class="form-control mb-2"  readonly="" tabindex="-1">
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		<h2>MOLD CHASE SECTION</h2>
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">SEARCH</label><input type="text" class="form-control" id="mcID">
