...
<?php
	if(!empty($_SESSION['userEmail'])){ ?>
		<form id="saveData" method="post" action="models/workpress/saveWP.php" enctype="multipart/form-data">
				...
				<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">WORK PRESS</h5>
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-4">
									SERIAL ID:<input id="gettd1" name="serialID" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									PACKAGE TYPE:<input id="gettd2" name="pckgType" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									PART NO:<input id="gettd3" name="prtNo" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									DUT REQ:<input id="gettd4" name="dutReq" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									MATERIAL:<input id="gettd5" name="material" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									VENDOR:<input id="gettd6" name="vendor" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									GS CODE:<input id="gettd7" name="gsCode" type="text" class="form-control mb-2" readonly="" tabindex="-1">
								</div>
								<div class="col-sm-4">
									TESTER MODEL:<input id="getTstPF" name="tstPf" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									HANDLER MODEL:<input id="gettd9" name="hdPf" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									MAX SHOT:<input id="gettd10" name="mShot" type="text" class="form-control mb-2 isNumberKey" readonly="" tabindex="-1">
									CURRENT SHOT COUNT:<input id="gettd11" name="crrntShotCnt" type="text" class="form-control mb-2"  readonly="" tabindex="-1">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/workpress/pagiResWP.php");
	}
}
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		<h2>WORK PRESS SECTION</h2>
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">SEARCH</label><input type="text" class="form-control mb-2" id="wpID">
