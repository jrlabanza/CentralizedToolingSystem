...
?>
		<form id="saveData" method="post" action="models/centerBoard/saveCB.php" enctype="multipart/form-data">
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									TYPE:<input id="getLBID" name="lbid" type="text" class="form-control mb-2" readonly="" tabindex="-1">
								...
								<div class="col-sm-6">
									...
									<!-- TESTER ID:<div id="getTstIDdiv"></div> -->
							...
							<div class="row">
								...
								SUPPORT FILE:
													...
													<input id="cbsfile" class="form-control-file mb-2" name="sfile" type="file" value="Choose file" accept=".jpg, .txt, .doc, .docx, .pdf, .xlsx, .csv, .jpeg, .jpg, .png, .bmp, .msg, .asc, .zip">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/centerBoard/pagiResCB.php");
	}
}
</script>
</HEAD>
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		<h2>CENTER BOARD SECTION</h2>
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">Loadboard ID:</label><input type="text" class="form-control" id="cbID">
