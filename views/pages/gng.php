...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									TEST TYPE:<input id="getTestType" name="testType" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									...
									<div class="row">
										...
										COLLECTION DATE:<input id="gettd13" name="storage" type="text" class="form-control mb-2" readonly="" tabindex="-1">
										</div>
										<div class="form-group col-sm-6">
										EXPIRATION DATE:<input id="getExpDate" name="storage" type="text" class="form-control mb-2" readonly="" tabindex="-1">
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									...
									<!-- PURPOSE:<select id="" name="loc" class="form-control mb-2" required="">
									<option value="" disabled selected></value>
									<option value="OPERATIONAL">OPERATIONAL</value>
									<option value="SETUP">SETUP</value>
									<option value="REPAIR">REPAIR</value>
									<option value="MAINTENANCE">MAINTENANCE</value>
									<option value="STANDBY">STANDBY</value>
									<option value="NO PLAN">NO PLAN</value>
									</select> -->
									<div class="row">
										<div class="form-group col-sm-6">
										...
										<div class="form-group col-sm-6">
											NO GOOD QTY:<input id="getnoGoodQty" maxlength="2" name="noGoodQty" type="text" class="form-control mb-2 isNumberKey" required>		
										</div>
									</div>
								</div>
								<div class="col-sm-12">
							...
							<div class="row">
								<div class="col-sm-12">
								SUPPORT FILE: <content id="getFile" ></content>
									<!-- <input type="file" class="custom-file-input" id="inputGroupFile01" required=""> -->
									<input id="sfileNotReq" class="form-control-file mb-2" name="sfile" type="file" value="Choose file" accept=".jpg, .txt, .doc, .docx, .pdf, .xlsx, .csv, .jpeg, .jpg, .png, .bmp, .msg, .asc, .zip, .S">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/gng/pagiResGNG.php");
	}
}
</script>
</HEAD>
	...
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		...
		<div class="col-md-2">
			...
			<select id="filter1" class="form-control">
				<option value=""></option>
				<?php include("models/gng/arealist.php"); ?>
			</select>
		</div>
		<div class="col-md-2">
			<label for="name">Search :</label><input type="text" class="form-control" id="gngID">
		</div>
		<div class="col-md-2">
			<button id="searchItem"type="submit" name="submit" class="btn btn-primary mt-4">Search</button>
		</div>
		<!-- <div class="col-md-3">
