...
?>
		<form id="saveData" method="post" action="models/trimAndFormDiesets/saveTFDS.php" enctype="multipart/form-data">
				...
				<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">TRIM AND FORM DIESETS</h5>
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									DIE SET NO.:<input id="gettd1" name="dieSetNo" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									<!-- ALTERNATIVE PART NO.:<input id="getPNo" name="altrntvSocket" type="text" class="form-control mb-2" readonly="" tabindex="-1"> -->
									<!-- BOX NO.:<input id="getLBID" name="boxNo" type="text" class="form-control mb-2" readonly="" tabindex="-1"> -->
									PACKAGE:<input id="gettd2" name="package" type="text" class="form-control mb-2" readonly="" tabindex="-1">
									DIE SET ID:<input id="gettd3" name="dieSetNoID" type="text" class="form-control mb-2"  readonly="" tabindex="-1">
									DIE MODEL:<input id="gettd4" name="dieModel" type="text" class="form-control mb-2"  readonly="" tabindex="-1">
									MACHINE MODEL:<input id="gettd5" name="machineModel" type="text" class="form-control mb-2"  readonly="" tabindex="-1">
									RACK:<input id="gettd6" name="machineModel" type="text" class="form-control mb-2"  readonly="" tabindex="-1">
									...
									VENDOR:<input id="gettd7" name="vendor" type="text" class="form-control mb-2"  readonly="" tabindex="-1">
								...
								<div class="col-sm-6">
									...
									MACHINE ID:<input list="assyEqpList" id="gettd8" name="machineID" type="text" class="form-control mb-2" required="">
		...
		<div class="col-xs-6 form-group">
			<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">MOLD CHASE</h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close" tabindex="-1">
				<span aria-hidden="true">×</span>
			</button>
		</div>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/moldchase/pagiResMC.php");
	}
}
</script>
</HEAD>
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		<h2>TRIM AND FORM DIESETS</h2>
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">SEARCH</label><input type="text" class="form-control" id="tfdID">
...
<script>
getresult("models/trimAndFormDiesets/pagiResTFDS.php");
</script>
