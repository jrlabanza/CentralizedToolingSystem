...
?>
		<form id="saveData" method="post" action="models/chipmountNozzle/saveNozzle.php" enctype="multipart/form-data">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/chipmountNozzle/pagiResChipmountNozzle.php");
	}
}
</script>
</HEAD>
