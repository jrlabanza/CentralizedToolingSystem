...
?>
		<form id="saveData" method="post" action="models/collet/saveCollet.php" enctype="multipart/form-data">
				...
				<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">COLLET</h5>
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									COLLET PART NO.:<input id="getSrID" name="nozzlePrtNO" type="text" class="form-control mb-2" readonly="" tabindex="-1">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/collet/pagiResCollet.php");
	}
}
</script>
</HEAD>
