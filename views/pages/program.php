...
<?php } ?>
							...
							<div class="row">
								...
								SUPPORT FILE:
													...
													<input id="sfile" class="form-control-file mb-2" name="sfile" type="file" value="Choose file" accept=".jpg, .txt, .doc, .docx, .pdf, .xlsx, .csv, .jpeg, .jpg, .png, .bmp, .msg, .asc, .zip">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/program/pagiResPG.php");
	}
}
</script>
</HEAD>
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		...
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">Search:</label><input type="text" class="form-control" id="pgID">
