...
<?php
	if(!empty($_SESSION['userEmail'])){ ?>
		<form id="saveData" method="post" action="models/socketBoard/saveSocketBoard.php" enctype="multipart/form-data">
				...
				<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">SOCKET BOARD</h5>
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-4">
									SOCKET BOARD ID:<input id="getLBID" name="socketid" type="text" class="form-control mb-2" readonly="" tabindex="-1">
								...
								<div class="col-sm-4">
									...
									TEMP:<input id="gettd1" name="temp" type="text" class="form-control mb-2" readonly="" tabindex="-1">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/socketBoard/pagiResSocketBoard.php");
	}
}
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		<h2>SOCKET BOARD SECTION</h2>
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">SOCKET BOARD ID:</label><input type="text" class="form-control mb-2" id="socketBoardID">
