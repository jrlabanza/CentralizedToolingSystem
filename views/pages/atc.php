...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									ACU NEED:<input id="getTestType" name="testType" type="text" class="form-control mb-2" readonly="" tabindex="-1">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/atc/pagiResATC.php");
	}
}
</script>
</HEAD>
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		<h2>AUTO CORR SECTION</h2>
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">Search :</label><input type="text" class="form-control" id="atcID">
