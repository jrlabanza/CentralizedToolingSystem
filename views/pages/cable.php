...
?>
		<form id="saveData" method="post" action="models/cable/saveCable.php" enctype="multipart/form-data">
				...
				<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">CABLE</h5>
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									CONNECTION TYPE:<input id="getFam" name="family" type="text" class="form-control mb-2" readonly="" tabindex="-1">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/cable/pagiResCable.php");
	}
}
</script>
</HEAD>
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		...
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">Search :</label><input type="text" class="form-control" id="cableID">
