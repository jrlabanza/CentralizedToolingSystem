...
?>
		<form id="saveData" method="post" action="models/spanker/saveSpanker.php" enctype="multipart/form-data">
				...
				<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">SPANKER</h5>
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									SPANKER PART NO.:<input id="getSrID" name="nozzlePrtNO" type="text" class="form-control mb-2" readonly="" tabindex="-1">
								...
								<div class="col-sm-6">
									...
									<!-- <label for="name">LOCATION:<select id="getLoc" name="loc" class="form-control" required="">
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/spanker/pagiResSpanker.php");
	}
}
</script>
</HEAD>
...
<div class="page-content"  style="width: 1600px;">
	<div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
		<h2>SPANKER SECTION</h2>
		<div class="form-group">
		<div class="row">
		<div class="col-md-4"><label for="name">SEARCH</label><input type="text" class="form-control" id="spankerID">
