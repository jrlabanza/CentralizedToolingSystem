...
?>
		<form id="saveData" method="post" action="models/nozzle/saveNozzle.php" enctype="multipart/form-data">
				...
				<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">CHIPMOUNT NOZZLE</h5>
...
<?php } ?>
							...
							<div class="row">
								<div class="col-sm-6">
									NOZZLE PART NO.:<input id="getSrID" name="nozzlePrtNO" type="text" class="form-control mb-2" readonly="" tabindex="-1">
		...
		<div class="col-xs-6 form-group">
			<div class="modal" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">NOZZLE</h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close" tabindex="-1">
				<span aria-hidden="true">×</span>
			</button>
		</div>
...
function changePagination(option) {
	if(option!= "") {
		getresult("models/nozzle/pagiResNozzle.php");
	}
}
</script>
</HEAD>
